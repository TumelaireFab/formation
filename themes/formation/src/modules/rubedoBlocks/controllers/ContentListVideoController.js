angular.module("rubedoBlocks").lazy.controller("ContentListVideoController",['$scope','$compile','RubedoContentsService',"$route","RubedoContentTypesService","RubedoPagesService","$location",function($scope,$compile,RubedoContentsService,$route,RubedoContentTypesService,RubedoPagesService,$location){
    var me = this;
    me.contentList=[];
